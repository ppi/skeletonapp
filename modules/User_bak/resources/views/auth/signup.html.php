...
<link rel="stylesheet" href="<?php echo $view['assets']->getUrl('css/signup.css') ?>" />
<?php $view['slots']->stop(); ?>
...
<script src="<?php echo $view['assets']->getUrl('js/signup.js') ?>"></script>
<?php $view['slots']->stop(); ?>

<section id="user-signup" class="clearfix well">
    ...
    <form action="<?=$view['router']->generate('User_Signup_Save');?>" method="post" class="form-horizontal">
