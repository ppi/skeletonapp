<?php $view->extend('::base.html.php'); ?>
    ...
    <div class="jumbotron">
        <div class="container">
            ...
            <p><a role="button" href="http://ppi.io" target="_blank" class="btn btn-primary btn-lg pull-right">Learn more »</a></p>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <p><a role="button" href="https://html5boilerplate.com/"  target="_blank" class="btn btn-default">Visit Site</a></p>
            </div>
            <div class="col-md-4">
                ...
                <p><a role="button" href="http://getbootstrap.com/" target="_blank" class="btn btn-default">Visit Site</a></p>
            </div>
            <div class="col-md-4">
                <h2>jQuery 1.11.2</h2>
                <p>Every web project needs jQuery, we have bundled the latest jquery here for you.</p>
                <p><a role="button" href="http://jquery.com/"  target="_blank" class="btn btn-default">Visit Site</a></p>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
                ...
                <p><a role="button" href="http://modernizr.com/"  target="_blank" class="btn btn-default">Visit Site</a></p>
            </div>
            <div class="col-md-4">
                <h2>Mustache JS</h2>
                ...
                <p><a role="button" href="https://mustache.github.io/"  target="_blank" class="btn btn-default">Visit Site</a></p>
            </div>
            <div class="col-md-4">
                <h2>jQuery Mobile</h2>
                ...
                <p><a role="button" href="https://jquerymobile.com/"  target="_blank" class="btn btn-default">Visit Site</a></p>
            </div>
        </div>
